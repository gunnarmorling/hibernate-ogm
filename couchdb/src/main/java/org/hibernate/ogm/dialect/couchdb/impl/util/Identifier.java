...
/**
 * Generates the ids used to create the {@link org.hibernate.ogm.dialect.couchdb.impl.backend.json.Document}
 *
...
public class Identifier {
	...
	/**
	 * Create the id used to store an {@link org.hibernate.ogm.dialect.couchdb.impl.backend.json.EntityDocument}
	 *
	...
	/**
	 * Create the id used to store an {@link org.hibernate.ogm.dialect.couchdb.impl.backend.json.AssociationDocument}
	 *
