 ...
 * MA  02110-1301, USA.
 */
package org.hibernate.ogm.dialect.couchdb.impl.datastore;
...
import org.hibernate.ogm.dialect.couchdb.impl.logging.Log;
import org.hibernate.ogm.dialect.couchdb.impl.logging.LoggerFactory;
...
public class CouchDBDatastoreProvider implements DatastoreProvider, Startable, Stoppable, ServiceRegistryAwareService, Configurable {
	 ...
	 * {@link org.hibernate.ogm.dialect.couchdb.CouchDB#ASSOCIATIONS_STORE} property. If no value is given for that
