 ...
 * MA  02110-1301, USA.
 */
package org.hibernate.ogm.dialect.couchdb.backend.facade.impl;
...
public interface DatabaseClient {
	...
	/**
	 * Retrieve the {@link org.hibernate.ogm.dialect.couchdb.backend.json.impl.EntityDocument} with the given id
	 *
	...
	/**
	 * Retrieve the {@link org.hibernate.ogm.dialect.couchdb.backend.json.impl.AssociationDocument} with the given id
	 *
	...
	/**
	 * Retrieve the {@link org.hibernate.ogm.dialect.couchdb.backend.json.impl.SequenceDocument} with the given id
	 *
	 ...
	 * {@link org.hibernate.ogm.dialect.couchdb.backend.json.designdocument.impl.EntityTupleRows}
	 */
	@GET
