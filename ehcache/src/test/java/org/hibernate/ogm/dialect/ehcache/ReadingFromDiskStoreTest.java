...
public class ReadingFromDiskStoreTest extends JpaTestCase {
	...
	protected void refineInfo(GetterPersistenceUnitInfo info) {
		String configurationResource = ReadingFromDiskStoreTest.class.getResource( "/enforced-disk-read-ehcache.xml" ).toExternalForm();
		info.getProperties().put( EhcacheProperties.RESOURCE_NAME, configurationResource  );
	}
