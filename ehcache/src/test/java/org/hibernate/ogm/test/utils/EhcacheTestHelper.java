...
import org.hibernate.ogm.dialect.ehcache.Ehcache;
import org.hibernate.ogm.dialect.ehcache.datastore.impl.Cache;
...
public class EhcacheTestHelper implements TestableGridDialect {
	...
	private static Cache<SerializableKey> getEntityCache(SessionFactory sessionFactory) {
	...
	private static Cache<SerializableKey> getAssociationCache(SessionFactory sessionFactory) {
		EhcacheDatastoreProvider castProvider = getProvider( sessionFactory );
